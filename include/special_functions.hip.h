// Some of these functions are adapted from the Cephes and specfun libraries:
...
#if !defined(SPECIAL_FUNCTIONS_HIP_H)
#define SPECIAL_FUNCTIONS_HIP_H
...
__device__ void si(double x, double *si) {
    double z, c, s, f, g;
    short sign;
...
#endif /* !defined(SPECIAL_FUNCTIONS_HIP_H) */
