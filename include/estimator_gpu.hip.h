...
void gpu_isf_launcher(hipStream_t s, double* __restrict__ isf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, int M, int N, int N_extent) {
    hipLaunchKernelGGL(gpu_isf, dim3(M/2 + 1), dim3(GPU_BLOCK_SIZE), 0, 0,
            isf, qvecs, beads, inorm, M, N, N_extent);
}
...
void gpu_ssf_launcher(double* __restrict__ ssf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, int M, int N, int N_extent, int n_qvecs) {
    hipLaunchKernelGGL(gpu_ssf, dim3(1), dim3(GPU_BLOCK_SIZE), 0, 0,
            ssf, qvecs, beads, inorm, M, N, N_extent, n_qvecs);
}
void gpu_ssf_launcher(hipStream_t s, double* __restrict__ ssf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, int M, int N, int N_extent, int n_qvecs) {
    hipLaunchKernelGGL(gpu_ssf, dim3(1), dim3(GPU_BLOCK_SIZE), 0, 0,
            ssf, qvecs, beads, inorm, M, N, N_extent, n_qvecs);
}
...
void gpu_es_launcher(hipStream_t s, double* __restrict__ isf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, int M, int N, int N_extent) {
    hipLaunchKernelGGL(gpu_isf<true>, dim3(M/2 + 1), dim3(GPU_BLOCK_SIZE), 0, 0,
            isf, qvecs, beads, inorm, M, N, N_extent);
}
