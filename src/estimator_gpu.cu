...
__global__ void gpu_isf(double* __restrict__ isf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, int M, int N, int N_extent) {
...
__global__ void gpu_ssf_cyl(double* __restrict__ ssf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, double maxR, int M, int N, int N_extent) {
...
void gpu_ssf_launcher(double* __restrict__ ssf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, int M, int N, int N_extent, int n_qvecs) {
    gpu_ssf<<<dim3(n_qvecs), dim3(GPU_BLOCK_SIZE), 0, 0>>>(ssf, qvecs, beads, inorm, M, N, N_extent);
}
void gpu_ssf_launcher(cudaStream_t s, double* __restrict__ ssf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, int M, int N, int N_extent, int n_qvecs) {
    gpu_ssf<<<dim3(n_qvecs), dim3(GPU_BLOCK_SIZE), 0, s>>>(ssf, qvecs, beads, inorm, M, N, N_extent);
}
...
void gpu_ssf_cyl_launcher(double* __restrict__ ssf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, double maxR, int M, int N, int N_extent, int n_qvecs) {
    gpu_ssf_cyl<<<dim3(n_qvecs), dim3(GPU_BLOCK_SIZE), 0, 0>>>(ssf, qvecs, beads, inorm, maxR, M, N, N_extent);
}
void gpu_ssf_cyl_launcher(cudaStream_t s, double* __restrict__ ssf, double* __restrict__ qvecs, double* __restrict__ beads, double inorm, double maxR, int M, int N, int N_extent, int n_qvecs) {
    gpu_ssf_cyl<<<dim3(n_qvecs), dim3(GPU_BLOCK_SIZE), 0, s>>>(ssf, qvecs, beads, inorm, maxR, M, N, N_extent);
}
